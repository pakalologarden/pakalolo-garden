        ...
        if (result.meta.changes > 0) {
          await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
              ...
              to: email,
              subject: 'Welcome to Pakalolo Garden',
              html: `
                <div style="max-width: 560px; margin: 0 auto; font-family: Georgia, serif; color: #2a3328; padding: 2rem;">
                  ...
                  <p style="line-height: 1.8; margin-bottom: 1rem;">I started Pakalolo Garden as a place to document what I'm learning and connect with other growers throughout Hawaiʻi.</p>
                  <p style="line-height: 1.8; margin-bottom: 1rem;">You'll occasionally receive updates from the garden — KNF experiments, breeding projects, cultivation observations, resources, and community updates.</p>
                  <p style="line-height: 1.8; margin-bottom: 2rem;">More importantly, my goal is to build relationships with people who care about regenerative growing, self-reliance, and cultivating better medicine.</p>
                  <p style="line-height: 1.8; margin-bottom: 2rem;">If you're local, hit reply and introduce yourself. I'd love to know what you're growing.</p>
